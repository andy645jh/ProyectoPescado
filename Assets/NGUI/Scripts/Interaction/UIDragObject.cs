...
public class UIDragObject : MonoBehaviour
{
	...
	public List<EventDelegate> onPressedBtn = new List<EventDelegate> ();
	public List<EventDelegate> onReleasedBtn = new List<EventDelegate> ();
	public List<EventDelegate> onDragRelease = new List<EventDelegate> ();
	//private bool _wasDragged = false;
	public bool wasDragged { set; get; }
	...
	void OnPress (bool pressed)
	{
		...
		if (enabled && NGUITools.GetActive(gameObject) && target != null)
		{
			...
			else if (mPressed && mTouchID == UICamera.currentTouchID)
			{
				...
				else EventDelegate.Execute ( onReleasedBtn );
